...
XVI / 十六开 includes or loads third-party software and fonts. Those works are not relicensed under the project's PolyForm Noncommercial License.
...
Users who import local font files are responsible for ensuring that their use and exported images comply with the font license they hold.

---

# 第三方授权说明

XVI / 十六开包含或在线载入第三方软件与字体。这些作品不适用项目的 PolyForm Noncommercial 许可，也不会因为出现在本仓库或页面中而被重新授权。
...
应用当前从 jsDelivr 与 ZeoSeven Fonts 请求字体样式表。每款字体继续遵循其作者或分发者发布的许可与使用条款。项目不主张拥有、不转授权，也不在仓库中重新分发这些远程字体文件。

用户导入本地字体时，应自行确认其使用方式与导出图片符合所持有的字体许可。
