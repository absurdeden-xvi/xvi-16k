...
- Cloudflare Pages hosts the public workspace; the legacy Netlify Forms endpoint receives explicit feedback, with direct email available as an alternative.
...
- 正式工作台由 Cloudflare Pages 托管；“来信”暂由原 Netlify Forms 端点代收，同时提供直接邮件渠道。
